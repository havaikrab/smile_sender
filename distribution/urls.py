...
urlpatterns = [
    ...
    path("mailing_management/", views.MailingManagementListView.as_view(), name="mailing_management"),
    ...
    path("mailing/stop/<int:pk>/", views.MailingStopView.as_view(), name="stop_mailing"),
]
